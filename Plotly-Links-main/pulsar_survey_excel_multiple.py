...
class Survey:
    ...
    def yy_xx(self, xl_file, df_file, counter: int, html_file):
        ...
        source = {
            ...
            'xx': xx,
            'yy': yy,
            'Legend (yy vs xx)': det_disc_list,
            'survey': survey_data,
            "URLs": psr_links
        }
        dafr = DataFrame(data=source)
        fig = px.scatter(dafr, x='xx', y='yy', color="Legend (yy vs xx)", width=500, height=500, title=survey_name, hover_name="Name", color_discrete_map={"PSRS Detected": "#00EEEE", "All Known Pulsars" : "#333", "PSRS Discovered": "#FF6103"}, custom_data=["URLs"],
    ...
    def zz_xx(self, xl_file, df_file, counter: int, html_file):
        ...
        source = {
            ...
            'xx': xx,
            'zz': zz,
            'Legend (zz vs xx)': det_disc_list,
            'survey': survey_data,
            "URLs": psr_links
        }

        # xx1=[21,14,3,4,8,6,71,8,9,10]
        # zz1=[12,2,23,4,5,-6,7,8,7,20]
        ...
        # }
        dafr = DataFrame(data=source)
        fig = px.scatter(dafr, x='xx', y='zz', color="Legend (zz vs xx)", width=500, height=500, title=survey_name, hover_name="Name", color_discrete_map={"PSRS Discovered": "#FF6103", "PSRS Detected": "#00EEEE", "All Known Pulsars" : "#333"}, custom_data=["URLs"],
                              # size of markers, "pop" is one of the columns of gapminder
                             )
