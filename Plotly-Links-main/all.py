...
# Home Page for Swinburne Pulsar Encyclopedia!
...
html_start_str = '\n' + ' <head>\n' + '  <title>\n' + 'Home' + '  </title>' + ' </head>' + ' <body>' + '<header>\n <h1>Swinburne Pulsar Encyclopedia</h1>\n'
html_css_navbar_str = '<html>\n<head>\n' + '<meta name="viewport" content="width=device-width, initial-scale=1">\n' + '<style>\n' + 'body {\n margin: 0;\n font-family: Arial, Helvetica, sans-serif;\n}\n\n.topnav {\n overflow: hidden;\n background-color: #005CD;\n}\n\n.topnav a {\n float: left\n color: #00C5CD\n text-align: center;\n padding: 30px 16px;\n text-decoration: none;\n font-size: 17px;\n}\n\n.topnav a:hover {\n padding: 30px 16px;\n background-color: #005CD;\n color: black;\n}\n\n.topnav a.active {\n background-color: #00C5CD;\n color: white;\n}\n</style>\n</head>\n<body>\n\n<div class="topnav">\n <a class="active" href="https://astronomy.swin.edu.au/~mbailes/encyc/home.html">Home</a>\n <a href="https://astronomy.swin.edu.au/~mbailes/encyc/pulsars.html">Pulsars</a>\n <a href="https://astronomy.swin.edu.au/~mbailes/encyc/surveys.html">Surveys</a>\n</div>\n\n<div style="padding-left:16px">\n</div>\n\n</body>'
html_end_str = '\n</body>' + '\n</html>'
print(html_css_navbar_str + html_start_str, file = html_file)
...
for i in range(len(psr_list)):
    ...
    if 'None' not in survey_func_str:
        if year_str == '':
            ...
            survey_str = ' as part of ' + '<a href="' + 'https://astronomy.swin.edu.au/~mbailes/encyc/' + survey_name + '_plots.html' + '">' + survey_func_str + '</a>' + '.'
    else:
        survey_str = ''
    # ORBITAL PERIOD
